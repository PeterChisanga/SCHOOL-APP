            ...
            <div class="card-body">
                ...
                @else
                    <div class="table-responsive">
                        ...
                        {{-- After existing exam results table for each term --}}
                        @if(isset($assessmentsByTerm[$term]) && $assessmentsByTerm[$term]->count() > 0)
                            <h5 class="mt-4">Continuous Assessments</h5>
                            <table class="table table-bordered table-sm">
                                ...
                                <tbody>
                                    @foreach($assessmentsByTerm[$term] as $assessment)
                                        <tr>
