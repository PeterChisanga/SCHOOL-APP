...
Route::group(['middleware' => 'teacher'], function() {
    ...
    Route::get('/timetables/class/{class_id}', [TimetableController::class, 'classView'])->name('timetables.class');
    Route::get('/timetables/teacher/{teacher_id}', [TimetableController::class, 'teacherView'])->name('timetables.teacher');
});
...
Route::get('/timetables/class/{class_id}', [TimetableController::class, 'classView'])->name('timetables.class');
Route::get('/timetables/teacher/{teacher_id}', [TimetableController::class, 'teacherView'])->name('timetables.teacher');
Route::get('/timetables/admin', [TimetableController::class, 'adminIndex'])->name('timetables.admin');
Route::post('/timetables/entry', [TimetableController::class, 'storeEntry'])->name('timetables.entry');
Route::get('/timetables/download', [TimetableController::class, 'downloadPdf'])->name('timetables.download');
Route::get('/timetables/share', [TimetableController::class, 'shareLink'])->name('timetables.share');
Route::post('/timetables/email', [TimetableController::class, 'emailTimetable'])->name('timetables.email');

// Fragment endpoints for AJAX updates
Route::get('/timetables/fragment/class/{class_id}', [TimetableController::class, 'fragmentClass'])->name('timetables.fragment.class');
Route::get('/timetables/fragment/teacher/{teacher_id}', [TimetableController::class, 'fragmentTeacher'])->name('timetables.fragment.teacher');
