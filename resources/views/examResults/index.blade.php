...
<div class="container">
    ...
    <<div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <!-- Button trigger modal (Supports both Bootstrap 4 and 5) -->
...
<div class="modal fade" id="sendSmsModal" tabindex="-1" aria-labelledby="sendSmsModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('results.sendSms') }}" method="POST">
                @csrf
                <div class="modal-header">
                    <h5 class="modal-title" id="sendSmsModalLabel">Send SMS Results</h5>
                    <button type="button" class="close btn-close" data-dismiss="modal" data-bs-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <p class="text-muted">Select the term for which you want to queue SMS results for all parents.</p>
                    <div class="mb-3 form-group">
                        <label for="modal_term" class="form-label">Term <span class="text-danger">*</span></label>
                        <select name="term" id="modal_term" class="form-control form-select" required>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary">Queue SMS Results</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <table class="table table-striped table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <small>
                        {{ $results->map(fn($r) => $r->subject?->name ?? 'N/A')->join(', ') }}
                    </small>
                </td>
